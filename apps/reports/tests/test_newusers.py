...
class TestNewUsers():
    ...
    def test_new_users_create(self):
        new_users = mixer.blend(NewUsers)
    ...
    def test_get_new_users_yearly_with_args(self):
        ...
        yearly_data = NewUsers.objects.filter(
            period='yearly').first()
